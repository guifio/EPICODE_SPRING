...
public class MessageService {
	...
	public List<Message> cercaDaTitolo(String title){
		List<Message> messaggiTrovati = repo.findByTitleContainingIgnoreCase(title);
		return messaggiTrovati;
	}
	
	public List<Message> cercaMessaggiMittente(User mittente){
		return repo.findByFromUser(mittente);
	}
	
	public List<Message> cercaMessaggiDestinatario(User destinatario){
		return repo.findByToUser(destinatario);
	}
	
	public List<Message> cercaMessaggiTitoloContent(String text){
		return repo.findByTitleOrContentContainingIgnoreCase(text);
	}
